...
public class ModEntityActions {
    public static final ActionFactory<Entity> CREEPER_BOOM = new ActionFactory<>(
            Seleni.identifier("creeper_boom"), new SerializableData()
                    ...
                    .add("destruction_type", SerializableDataType.enumValue(World.ExplosionSourceType.class), World.ExplosionSourceType.NONE),
